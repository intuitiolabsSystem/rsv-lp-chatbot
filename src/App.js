...
IMPORTANT: The data below is sourced directly from the official LP Pitch Deck, Fund Model Excel, and the canonical LP FAQ. Always use these numbers — they supersede any earlier versions.

When discussing return projections, include a brief note that these are model-based estimates and do not guarantee future performance, and that prospective LPs should review the PPM and consult independent advisors before investing.


== PITCH DECK — OFFICIAL SOURCE ==
...
- More Bets. Same Capital: At $3M we are no longer excluded structurally from power law advantages. Net MOIC top quartile: 2.5x+ · Net IRR top quartile: >15% · Write-off norm: 60–70%.
...
Note: GP Commit is 10% → $300,000. The $330K figure on the team slide reflects personal pre-fund capital deployed across companies before Fund I.
...
Fund Performance:
- Net MOIC / TVPI: 14.2x (top-decile outcome)
- Net IRR: ~50.1%
- DPI: 8.9x+ (exceptional)
Benchmark Context: Best case DPI of 8.9x is exceptional. One company returning ~$5M at 7% ownership = $75M exit. Not common but well within range of pre-seed outcomes at this ownership level. Best case is a mathematical upper bound — the fund is managed against the base case.
...
A: $300,000 — 10% of the fund. Management fees are charged on $2.7M, not $3M, because the GP commit is excluded from the fee base. The ILPA recommended minimum is 1–2%. We are at 5× that minimum. Our capital is at risk alongside yours under identical terms. Note: the $330K figure that appears on the team slide refers to personal capital deployed across companies before Fund I was formally constituted — it is not the Fund I GP commit.
...
1. Revenue or paid traction: early revenue or paying customers — not just users, not just a waitlist.
2. Outside capital raised: a SAFE, angel round, or acceptance into another accelerator — an independent third-party signal of conviction.
...
All three is a strong signal; none of three means T2 capital stays in reserve.

Q: What happens to the $25K Tranche 1 for companies that don't pass the milestone gate?
A: T1 is $25K deployed to the founder as studio credits, redeemable for Intuitio Labs product services at $55/hr — a fraction of market rate. Every dollar goes toward building the product. For companies that don't advance, $25K is the full cost of that evaluation. The $75K Growth Capital never deploys.

Q: Why deploy capital as studio credits rather than just writing a check?
A: Most pre-seed founders don't fail for lack of cash — they fail because the cash goes to building the wrong thing. Market rate for MVP development from an institutional-quality agency runs $75,000 to well over $150,000. A founder who spends that on a prototype before raising has consumed most of their pre-seed capital before a single customer has touched the product. RSV's $25K in studio credits at $55/hr gets founders to a working MVP without torching their runway. The structure isn't a constraint — it's capital efficiency by design.
...
A: Power law dynamics require a minimum of 20–30 portfolio companies to have a reliable chance of capturing an outlier. A traditional $3M fund writing $100K flat checks can back only ~22 companies after fees — below that threshold. Our two-tranche structure gets us to 32 on the same invested capital. Here's how: 20 companies are funded initially. 40% (8 companies) clear the milestone gate and receive Tranche 2 ($75K). The 60% that don't pass stop at $25K, freeing $75K per company for immediate recycling. That freed capital funds 12 additional companies. Total: 32 companies, $1.775M deployed across T1 and T2, $474K held as reserve.

Q: What is the fund's capital deployment schedule?
A: $2.249M in invested capital deployed across a 4-year investment period into 32 companies. Every company enters at $25K. 40% clear the milestone gate and receive the full $75K Tranche 2. The 60% that don't stop at $25K — and that freed $75K per company goes back into the pipeline to fund the next entry check. The 4-year investment window is matched to the 10-year fund duration with a 2-year extension baked in.
...
A: $300,000 — 10% of the $3M fund. Approximately 5× the ILPA recommended minimum of 1–2%. The GP commit is excluded from the management fee base per the ILPA fee transparency framework. Our capital is at risk alongside yours under identical terms.
