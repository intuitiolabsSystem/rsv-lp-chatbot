...
IMPORTANT: The data below is sourced directly from the official LP Pitch Deck (Version 5, March 2026) and Fund Model Excel (March 9, 2026). Always use these numbers — they supersede any earlier versions.
...
- RightShift Ventures (Fund): $3M investment vehicle. Invests in ecosystem graduates and a structured outside track. Up to $30K Product Capital + $75K Growth Capital. Capital deploys only after product is de-risked.
NOTE: The Ecosystem slide describes the Fund as "Up to $30K Product Capital + $75K Growth Capital." The Investment Structure slide and Fund Model consistently use $25K for Tranche 1. When asked, use $25K as the operative number for the two-tranche model and note the deck's Ecosystem summary rounds up to $30K.
...
"Why RightShift Ventures Is Different — The search model is crowded. We built something else."
- The Model: Every fund competes for the same narrow pool of product-ready founders. We create that pool. Tranche 1 is product engineering capital — turning pre-product founders into investable companies. We don't find the needle. We make more of them. (vs. YC/Techstars/500 Global: search and diversify, fixed supply, same playbook for 20 years)
- Why We Can Do This: Studio builds. Accelerator shapes. Fund deploys — $25K first, $75K only when milestones clear. No fund runs a milestone-gated two-tranche structure backed by a product studio. Traction: 3 cohorts · VULVAi NIA Finalist · Echoing Green Fellow · Ballin.ai · TuneCore Social · Ikonik Golf
- Power Law on $3M: One $10M exit at 7% moves the needle. Impossible at $100M. Capital only concentrates in companies that proved execution. Net MOIC top quartile: 2.5x+ · Net IRR top quartile: >15% · Write-off norm: 60–70%. Return scenarios: Conservative 1.66x · 8.7% IRR · Base 2.76x · 18.4% IRR (top quartile) · Best 14.2x · 50.1% IRR · $474K reserve not modeled in any scenario.
