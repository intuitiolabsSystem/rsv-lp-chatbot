...
IMPORTANT: The data below is sourced directly from the official LP Pitch Deck (Version 6, March 2026) and Fund Model Excel (March 9, 2026). Always use these numbers — they supersede any earlier versions.
...
- The Model: Every fund competes for the same narrow pool of product-ready founders. We are building new supply. Tranche 1 is product engineering capital — turning pre-product founders into investable companies. We don't find the needle. We make more of them. (vs. YC/Techstars/500 Global: search and diversify, fixed supply, same playbook for 20 years)
- Capital efficiency due to embedded diligence: Accelerator shapes. Studio builds. Fund deploys — $25K first, $75K only when milestones clear. No fund runs a milestone-gated two-tranche structure backed by a product studio. They all typically write the same check to everyone on day one.
- Power Law on $3M: One $10M exit at 7% moves the needle. Impossible at $100M. Capital only concentrates in companies that proved execution. Net MOIC top quartile: 2.5x+ · Net IRR top quartile: >15% · Write-off norm: 60–70%.
...
Anastasia Nicole (anastasia@rightshift.co): 50 investments across North America and Europe. Shadow Ventures. Founder Gym Atlanta 30 Under 30. Southeast climatetech and edtech champion.
...
- Just the small ($3M) and medium ($15M) exits alone return the fund and then some. That's the two-tranche model at work.
